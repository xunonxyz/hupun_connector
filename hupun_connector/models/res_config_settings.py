...
class ResConfigSettings(models.TransientModel):
    ...
    hupun_app_key = fields.Char(string='Hupun App Key', config_parameter='hupun_connector.app_key')
    hupun_app_secret = fields.Char(string='Hupun App Secret', config_parameter='hupun_connector.app_secret')
